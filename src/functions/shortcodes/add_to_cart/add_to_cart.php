 ...
 * When empty: Shows "Visit Shop" button (yellow button on desktop)
 * When has items: Shows item count, total, and opens modal on click
 * Includes a modal popup with cart items list (rendered once via footer)
 *
...
function ats_mini_cart_shortcode() {
    ...
    <div class="rfs-ref-mini-cart-wrapper js-mini-cart-wrapper relative" data-ats-mini-cart data-cart-url="<?php echo esc_url( wc_get_cart_url() ); ?>" data-checkout-url="<?php echo esc_url( wc_get_checkout_url() ); ?>" data-shop-url="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>">
        ...
        <div class="rfs-ref-mini-cart-empty js-mini-cart-empty" style="display: none;">
            <a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>" class="rfs-ref-empty-cart-link ats-btn ats-btn-sm ats-btn-yellow flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor">
                    <path d="M280-80q-33 0-56.5-23.5T200-160q0-33 23.5-56.5T280-240q33 0 56.5 23.5T360-160q0 33-23.5 56.5T280-80Zm400 0q-33 0-56.5-23.5T600-160q0-33 23.5-56.5T680-240q33 0 56.5 23.5T760-160q0 33-23.5 56.5T680-80ZM246-720l96 200h280l110-200H246Zm-38-80h590q23 0 35 20.5t1 41.5L692-482q-11 20-29.5 31T622-440H324l-44 80h480v80H280q-45 0-68-39.5t-2-78.5l54-98-144-304H40v-80h130l38 80Zm134 280h280-280Z"/>
                </svg>
                <span class="text-sm font-semibold uppercase"><?php esc_html_e( 'Visit Shop', 'skylinewp-dev-child' ); ?></span>
            </a>
        </div>
        ...
        <div class="rfs-ref-mini-cart-loading js-mini-cart-loading">
            <div class="flex items-center gap-2 px-4 py-2">
                ...
                <span class="text-sm text-ats-text"><?php esc_html_e( 'Loading cart...', 'skylinewp-dev-child' ); ?></span>
            </div>
        </div>
...
/**
 * Render the mini cart modal in the footer (only once)
 */
function ats_render_mini_cart_modal() {
    ...
    ?>
    <!-- Mini Cart Modal (rendered once in footer) -->
    <div tabindex="-1" aria-hidden="true" class="rfs-ref-mini-cart-modal js-mini-cart-modal hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 justify-center items-start">
        <div class="rfs-ref-mini-cart-modal-backdrop js-mini-cart-backdrop fixed inset-0 bg-black bg-opacity-50"></div>
        <div class="rfs-ref-mini-cart-modal-container js-mini-cart-modal-container relative p-4 w-full max-w-lg mx-auto mt-4 lg:mt-8 max-h-[90vh] lg:max-h-none">
            <!-- Modal content -->
            <div class="rfs-ref-mini-cart-modal-content js-mini-cart-modal-content relative bg-white rounded-lg shadow-xl flex flex-col max-h-[calc(90vh-2rem)] lg:max-h-none">
                <!-- Modal header -->
                <div class="rfs-ref-mini-cart-modal-header flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0">
                ...
                <div class="rfs-ref-mini-cart-modal-body js-mini-cart-modal-body js-mini-cart-items p-4 overflow-y-auto flex-grow">
                ...
                <div class="rfs-ref-mini-cart-modal-footer border-t border-gray-200 p-4 bg-gray-50 rounded-b-lg flex-shrink-0">
                    <!-- Totals -->
                    ...
                    <div class="rfs-ref-mini-cart-modal-actions flex flex-col gap-2">
                        ...
                        <button type="button" class="text-sm text-ats-text hover:text-ats-dark underline js-mini-cart-close">
...
add_action( 'wp_footer', 'ats_render_mini_cart_modal', 20 );
