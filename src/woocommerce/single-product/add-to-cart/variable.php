			...
			<?php foreach ( $attributes as $attribute_name => $options ) : ?>
				...
				<div class="variation-row flowbite-dropdown-wrapper group" data-attribute-name="<?php echo esc_attr( $attribute_name ); ?>">
					...
					<div class="value relative">
                        ...
                        <div id="<?php echo esc_attr( $dropdown_id ); ?>" class="ats-dropdown-menu absolute z-50 hidden bg-ats-dark divide-y divide-gray-700 rounded-lg shadow-lg w-full mt-1 max-h-60 overflow-y-auto">
