...
?>
                ...
                <div class="rfs-ref-footer-col-newsletter lg:col-span-4">
                    ...
                    <!-- Social Media Links -->
                    <div class="rfs-ref-footer-social-links flex items-center gap-3 mt-6">
                        <!-- X (Twitter) -->
                        <a href="https://x.com/atsdiamondtools" target="_blank" rel="noopener noreferrer" class="rfs-ref-social-x text-gray-600 hover:text-gray-900 transition-colors" aria-label="Follow us on X">
                        ...
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/atsdiamondtools/" target="_blank" rel="noopener noreferrer" class="rfs-ref-social-facebook text-gray-600 hover:text-blue-600 transition-colors" aria-label="Follow us on Facebook">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
